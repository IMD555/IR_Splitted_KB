...
void SYSTEM_Initialize(SYSTEM_STATE state)
{
	...
	case SYSTEM_STATE_USB_START:
		...
		LED_Enable(LED_USB_DEVICE_HID_KEYBOARD_SCROOL_LOCK);
...
//void __attribute__((interrupt, auto_psv)) _OC2Interrupt()
//{
//	//???
//	IFS0bits.OC2IF = 0;
//	IEC0bits.OC2IE = 0;
...
//	irRxBuffer.buffer[irRxBuffer.writeIndex++] = data;
