...
#define LED_D4_LAT      LATBbits.LATB8
#define LED_D5_LAT      LATBbits.LATB7
#define LED_D6_LAT      LATAbits.LATA3
#define LED_D7_LAT      LATAbits.LATA2

#define LED_D4_TRIS     TRISBbits.TRISB8
#define LED_D5_TRIS     TRISBbits.TRISB7
#define LED_D6_TRIS     TRISAbits.TRISA3
#define LED_D7_TRIS     TRISAbits.TRISA2
