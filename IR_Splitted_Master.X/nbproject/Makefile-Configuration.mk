...
SOURCEFILES_QUOTED_IF_SPACED=leds.c buttons.c usb_device.c usb_descriptors.c usb_device_hid.c usb_events.c usb_hal_16bit.c system.c app_device_keyboard.c main.c app_led_usb_status.c ringBuffer.c swMatrix.c ../IR_format.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/leds.o ${OBJECTDIR}/buttons.o ${OBJECTDIR}/usb_device.o ${OBJECTDIR}/usb_descriptors.o ${OBJECTDIR}/usb_device_hid.o ${OBJECTDIR}/usb_events.o ${OBJECTDIR}/usb_hal_16bit.o ${OBJECTDIR}/system.o ${OBJECTDIR}/app_device_keyboard.o ${OBJECTDIR}/main.o ${OBJECTDIR}/app_led_usb_status.o ${OBJECTDIR}/ringBuffer.o ${OBJECTDIR}/swMatrix.o ${OBJECTDIR}/_ext/1472/IR_format.o
POSSIBLE_DEPFILES=${OBJECTDIR}/leds.o.d ${OBJECTDIR}/buttons.o.d ${OBJECTDIR}/usb_device.o.d ${OBJECTDIR}/usb_descriptors.o.d ${OBJECTDIR}/usb_device_hid.o.d ${OBJECTDIR}/usb_events.o.d ${OBJECTDIR}/usb_hal_16bit.o.d ${OBJECTDIR}/system.o.d ${OBJECTDIR}/app_device_keyboard.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/app_led_usb_status.o.d ${OBJECTDIR}/ringBuffer.o.d ${OBJECTDIR}/swMatrix.o.d ${OBJECTDIR}/_ext/1472/IR_format.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/leds.o ${OBJECTDIR}/buttons.o ${OBJECTDIR}/usb_device.o ${OBJECTDIR}/usb_descriptors.o ${OBJECTDIR}/usb_device_hid.o ${OBJECTDIR}/usb_events.o ${OBJECTDIR}/usb_hal_16bit.o ${OBJECTDIR}/system.o ${OBJECTDIR}/app_device_keyboard.o ${OBJECTDIR}/main.o ${OBJECTDIR}/app_led_usb_status.o ${OBJECTDIR}/ringBuffer.o ${OBJECTDIR}/swMatrix.o ${OBJECTDIR}/_ext/1472/IR_format.o

# Source Files
SOURCEFILES=leds.c buttons.c usb_device.c usb_descriptors.c usb_device_hid.c usb_events.c usb_hal_16bit.c system.c app_device_keyboard.c main.c app_led_usb_status.c ringBuffer.c swMatrix.c ../IR_format.c
...
${OBJECTDIR}/leds.o: leds.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/leds.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  leds.c  -o ${OBJECTDIR}/leds.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/leds.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -fno-schedule-insns -fno-schedule-insns2 -O0 -mpa -falign-arrays -I"." -msmart-io=1 -Wall -msfr-warn=off   -std=c99
...
${OBJECTDIR}/swMatrix.o: swMatrix.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/swMatrix.o.d 
	@${RM} ${OBJECTDIR}/swMatrix.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  swMatrix.c  -o ${OBJECTDIR}/swMatrix.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/swMatrix.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -fno-schedule-insns -fno-schedule-insns2 -O0 -mpa -falign-arrays -I"." -msmart-io=1 -Wall -msfr-warn=off   -std=c99
	@${FIXDEPS} "${OBJECTDIR}/swMatrix.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/_ext/1472/IR_format.o: ../IR_format.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1472" 
	@${RM} ${OBJECTDIR}/_ext/1472/IR_format.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/IR_format.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../IR_format.c  -o ${OBJECTDIR}/_ext/1472/IR_format.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1472/IR_format.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -fno-schedule-insns -fno-schedule-insns2 -O0 -mpa -falign-arrays -I"." -msmart-io=1 -Wall -msfr-warn=off   -std=c99
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/IR_format.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/leds.o: leds.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/leds.o.d 
	@${RM} ${OBJECTDIR}/leds.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  leds.c  -o ${OBJECTDIR}/leds.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/leds.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -fno-schedule-insns -fno-schedule-insns2 -O0 -mpa -falign-arrays -I"." -msmart-io=1 -Wall -msfr-warn=off   -std=c99
	@${FIXDEPS} "${OBJECTDIR}/leds.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/buttons.o: buttons.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/buttons.o.d 
	@${RM} ${OBJECTDIR}/buttons.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  buttons.c  -o ${OBJECTDIR}/buttons.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/buttons.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -fno-schedule-insns -fno-schedule-insns2 -O0 -mpa -falign-arrays -I"." -msmart-io=1 -Wall -msfr-warn=off   -std=c99
	@${FIXDEPS} "${OBJECTDIR}/buttons.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/usb_device.o: usb_device.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/usb_device.o.d 
	@${RM} ${OBJECTDIR}/usb_device.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  usb_device.c  -o ${OBJECTDIR}/usb_device.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/usb_device.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -fno-schedule-insns -fno-schedule-insns2 -O0 -mpa -falign-arrays -I"." -msmart-io=1 -Wall -msfr-warn=off   -std=c99
	@${FIXDEPS} "${OBJECTDIR}/usb_device.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/system.o: system.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/system.o.d 
	@${RM} ${OBJECTDIR}/system.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  system.c  -o ${OBJECTDIR}/system.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/system.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -fno-schedule-insns -fno-schedule-insns2 -O0 -mpa -falign-arrays -I"." -msmart-io=1 -Wall -msfr-warn=off   -std=c99
	@${FIXDEPS} "${OBJECTDIR}/system.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/main.o: main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/main.o.d 
	@${RM} ${OBJECTDIR}/main.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  main.c  -o ${OBJECTDIR}/main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/main.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -fno-schedule-insns -fno-schedule-insns2 -O0 -mpa -falign-arrays -I"." -msmart-io=1 -Wall -msfr-warn=off   -std=c99
	@${FIXDEPS} "${OBJECTDIR}/main.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/swMatrix.o: swMatrix.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/swMatrix.o.d 
	@${RM} ${OBJECTDIR}/swMatrix.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  swMatrix.c  -o ${OBJECTDIR}/swMatrix.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/swMatrix.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -fno-schedule-insns -fno-schedule-insns2 -O0 -mpa -falign-arrays -I"." -msmart-io=1 -Wall -msfr-warn=off   -std=c99
	@${FIXDEPS} "${OBJECTDIR}/swMatrix.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/IR_Splitted_Master.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/IR_Splitted_Master.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -DXPRJ_Configuration=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -Wl,--local-stack,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=64,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
